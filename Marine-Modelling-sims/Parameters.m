...
Para.S4.Mg = Para.S4.Mb + Para.S4.Ma;
Para.S5.Mg = Para.S5.Mb + Para.S5.Ma;

Para.Mg = Para.S0.Mg + Para.S1.Mg + Para.S2.Mg + Para.S3.Mg + Para.S4.Mg + Para.S5.Mg;
...
%S4
Para.S4.kuu = 8.5714;    % surge
Para.S4.kvv = 8.5714;    % sway
Para.S4.kww = 0;    % heave
Para.S4.kpp = 0;    % roll
Para.S4.kqq = 0;    % pitch
Para.S4.krr = 0;    % yaw

Para.S4.Kq = -diag([Para.S4.kuu Para.S4.kvv Para.S4.kww Para.S4.kpp Para.S4.kqq Para.S4.krr]) ;    %Quadratic friction matrix

%S5
Para.S5.kuu = 8.5714;    % surge
Para.S5.kvv = 8.5714;    % sway
Para.S5.kww = 0;    % heave
Para.S5.kpp = 0;    % roll
Para.S5.kqq = 0;    % pitch
Para.S5.krr = 0;    % yaw

Para.S5.Kq = -diag([Para.S5.kuu Para.S5.kvv Para.S5.kww Para.S5.kpp Para.S5.kqq Para.S5.krr]) ;    %Quadratic friction matrix
%% Thruster modelling
% NO EDIT NEEDED 
